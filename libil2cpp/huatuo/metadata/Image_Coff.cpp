...
namespace metadata
{
	...
	bool Image::TranslateRVAToImageOffset(uint32_t rvaOffset, uint32_t& imageOffset)
	{
	...
	LoadImageErrorCode Image::LoadTables()
	{
	...
	LoadImageErrorCode Image::LoadStreams()
	{
		{
	...
	uint32_t Image::ComputTableRowMetaDataSize(TableType tableIndex)
	{
		switch (tableIndex)
		{
